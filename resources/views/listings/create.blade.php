    ...
    <x-card class="p-10 max-w-lg mx-auto mt-24">
        ...
        <form method="POST" action="/listings">
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="company"  placeholder="Example: EU/ Valorant Diamong Player"/>
                @error('company')
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="website" placeholder="A small clip of your gameplay"/>
                @error('website')
                <p class='text-red-500 text-xs mt-1'>{{$message}}</p>
                @enderror
            </div>
            ...
            <div class="mb-6">
                <button class="bg-laravel text-white rounded py-2 px-4 hover:bg-black">Create</button>
